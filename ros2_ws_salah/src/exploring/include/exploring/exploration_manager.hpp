...
private:
  ...
  /// forward_vector is the unit vector from drone to the frontier centroid,
  /// used to define a dynamic "forward" direction instead of a fixed global axis.
  ...
  /// Sliding-window blacklist: oldest entry evicted when size exceeds blacklist_max_size_
