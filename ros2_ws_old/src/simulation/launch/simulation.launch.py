...
def generate_launch_description():
    ...
    fisheye_info_topic = LaunchConfiguration("fisheye_info_topic")
    ...
    declared_args = [
        ...
        DeclareLaunchArgument(
            "fisheye_image_topic", default_value="/realsense/fisheye/image_rect_raw"
        ),
        DeclareLaunchArgument(
            "fisheye_info_topic", default_value="/realsense/fisheye/camera_info"
        ),
        DeclareLaunchArgument(
            "semantic_image_topic", default_value="/realsense/semantic/image_rect_raw"
        ),
        DeclareLaunchArgument(
            "semantic_info_topic", default_value="/realsense/semantic/camera_info"
        ),
    ...
    unity_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "fisheye_info_topic": fisheye_info_topic,
            "imu_topic": imu_topic,
        }.items(),
    )
